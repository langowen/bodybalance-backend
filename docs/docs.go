    ...
    "definitions": {
        "github_com_langowen_bodybalance-backend_internal_http-server_admin_admResponse.CategoryRequest": {
            ...
            "properties": {
                ...
                "type_ids": {
                    "description": "Список ID типов, к которым относится категория\nrequired: true\nexample: [1, 2]",
                    "type": "array",
                    "items": {
                        "type": "integer"
                    }
        ...
        "github_com_langowen_bodybalance-backend_internal_http-server_admin_admResponse.UserRequest": {
            ...
            "properties": {
                ...
                "content_type_id": {
                    "description": "ID типа контента\nexample: 1",
                    "type": "string"
                },
                "password": {
                    "description": "Пароль пользователя\nrequired: true\nexample: token(password123)",
                    "type": "string"
                },
                "username": {
